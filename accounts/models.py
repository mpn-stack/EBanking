...
from .gender import GENDER_CHOICE
from .installments import INSTALLMENT_CHOICE
...
class BankBranche (models.Model):
...
class UserBankAccount(models.Model):
    ...
    branche_name = models.ForeignKey(
        BankBranche,
        related_name='accounts',
        on_delete=models.CASCADE
    )
...
class Loan(models.Model):
    ...
    number_of_installments = models.CharField(max_length=2, choices=INSTALLMENT_CHOICE)
    paid_installments = models.PositiveSmallIntegerField(
        default=0,
        validators=[MinValueValidator(0), MaxValueValidator(24)],
        help_text='The number of paid installments'
    )
